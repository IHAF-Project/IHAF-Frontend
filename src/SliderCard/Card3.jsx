  ...
  const tamilLanguage =i18n.language === 'ta'
    ...
    return (
     ...
     <img src={Quets} alt='quates' />
      ...
      <p className={`${tamilLanguage ? 'Quates-tamil' : 'Quates-english'}`}>“ {currentLanguage === 'ta' ? t('pageOne.3') : t('If a vote for everyone is the touchstone of political democracy, work, food and education  for everyone is a measure of economic democracy.')}”</p>
